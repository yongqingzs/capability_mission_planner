...
// Adapted from libMultiRobotPlanning under the MIT license.
// See third_party/licenses/libMultiRobotPlanning-MIT.txt.
...
#include <capability_mission_planner/search/neighbor.hpp>
#include <capability_mission_planner/search/plan_result.hpp>
